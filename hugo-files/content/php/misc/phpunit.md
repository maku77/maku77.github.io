---
title: "PHPメモ: PHPUnit を使用してユニットテストを行う"
url: "/p/bhnowgh/"
date: "2012-09-22"
tags: ["php"]
aliases: [/php/misc/phpunit.html]
---
...
{{< code lang="php" title="Counter.php（テスト対象のクラス）" >}}
<?php
class Counter {
...
{{< code lang="php" title="CounterTest.php（Counter クラスのテストケース）" >}}
<?php
