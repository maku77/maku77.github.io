---
title: "PHPメモ: PDO を使ってデータベースにアクセスする"
url: "/p/3hg9v8y/"
date: "2012-01-15"
tags: ["php"]
aliases: [/php/pdo/basic.html]
---
...
開発中は、あえて例外を捕捉せずに、デフォルトの詳細なエラーメッセージを表示するという手もあります。
...
sqlite> INSERT INTO urls(title, url) VALUES('Google', 'https://google.com/');
sqlite> INSERT INTO urls(title, url) VALUES('Yahoo', 'https://yahoo.com/');
sqlite> INSERT INTO urls(title, url) VALUES('Bing', 'https://bing.com/');
```
...
- 参考
  - PDO クラス: https://www.php.net/manual/en/class.pdo.php
  - PDOStatment クラス: https://www.php.net/manual/en/class.pdostatement.php
