---
title: "PHPメモ: DateTime クラスで時刻を扱う"
url: "/p/u3g92jc/"
date: "2012-07-31"
tags: ["php"]
aliases: [/php/time/datetime.html]
---
...
文字列から DateTime オブジェクトを作成する
----

`YYYY-MM-DD hh:mm:ss` といった日時を表す文字列から、`DateTime` オブジェクトを生成することもできます。
