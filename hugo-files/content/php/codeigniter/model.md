---
title: "PHPメモ: CodeIgniter - モデルクラスを使用してデータベースから値を取得する"
url: "/p/q4uoqkq/"
date: "2012-07-22"
tags: ["php"]
aliases: [/php/codeigniter/model.html]
---
...
{{< code lang="php" title="Books コントローラー (application/controllers/books.php)" >}}
<?php
...
ここでは、`Books_model` クラスの `get_all()` メソッドを使ってテーブルの全エントリを配列で取得し、ビュー (`show_all.php`) にそのデータを渡しています。


{{< code lang="php" title="Books_model モデル (application/models/books_model.php)" >}}
<?php
...
{{< code lang="html" title="show_all ビュー (application/views/show_all.php)" >}}
<html>
<body>
  <ul>
