---
title: "PHPメモ: CodeIgniter - コントローラーを作成する"
url: "/p/n2grmxx/"
date: "2012-05-29"
tags: ["php"]
aliases: [/php/codeigniter/create-controller.html]
---
...
{{< code lang="php" title="application/controllers/hello.php" >}}
<?php
...
{{< code lang="php" title="Hello コントローラ (application/controllers/hello.php)" >}}
<?php
class Hello extends CI_Controller {
    public function index() {
