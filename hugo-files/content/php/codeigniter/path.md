---
title: "PHPメモ: CodeIgniter - 相対パスの扱い方のまとめ"
url: "/p/a837as6/"
date: "2013-03-02"
tags: ["php"]
aliases: [/php/codeigniter/path.html]
---
...
{{< code lang="php" title="index.php 抜粋" >}}
$application_folder = 'application';
{{< /code >}}

CodeIgniter 関連のコード内から単純に相対パスを使用すると、基本的には、ブラウザのアドレス欄に表示されている URL に対しての相対パス指定として動作します。
...
{{< code lang="php" title="ビュー内で相対リンクを作成" >}}
...
`url` ヘルパーを使用するときは、コントローラのコンストラクタなどで、以下のようにロードしておく必要があります。

{{< code lang="php" title="コントローラ内で url ヘルパーをロード" >}}
...
```php
<link href="https://＜IgniterRoot＞/css/main.css" rel="stylesheet" type="text/css" />
```
...
{{< code lang="php" title="コントローラ内で html ヘルパーをロード" >}}
