---
title: "PHPメモ: CodeIgniter - フォームに入力した値をコントローラーで受け取る"
url: "/p/vi2ua3z/"
date: "2012-07-21"
tags: ["php"]
aliases: [/php/codeigniter/get-form-input.html]
---
...
{{< image border="true" title="実行画面" src="img-001.png" >}}

{{< code lang="html" title="form_sample ビュー (application/views/form_sample.php)" >}}
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
...
{{< code lang="php" title="Form_sample コントローラー (application/controllers/form_sample.php)" >}}
<?php
