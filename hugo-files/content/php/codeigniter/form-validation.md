---
title: "PHPメモ: CodeIgniter - Form Validation クラスでフォームに入力された値を検査する"
url: "/p/o95kqfk/"
date: "2012-08-14"
tags: ["php"]
aliases: [/php/codeigniter/form-validation.html]
---
...
- 参考: [Form Validation : CodeIgniter User Guide](https://codeigniter.com/user_guide/libraries/form_validation.html)
...
{{< code lang="html" title="form_view ビュー (application/views/form_view.php)" >}}
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
{{< code lang="php" title="Validation_test コントローラー (application/controllers/validation_test.php)" >}}
<?php
class Validation_test extends CI_Controller {
...
- 参考: [Form Validation - Rule Reference](https://codeigniter.com/user_guide/libraries/form_validation.html#rule-reference)
...
最初にユーザが、`https://your.site/validation_test/` にアクセスした時は、何もまだ入力がないので、当然 `form_validation->run()` は失敗し、`form_view` ビューが表示されます。
