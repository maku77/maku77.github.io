---
title: "PHPメモ: CodeIgniter - ユーザのログイン状態を管理する"
url: "/p/yv8mz9p/"
date: "2012-08-14"
tags: ["php"]
aliases: [/php/codeigniter/manage-login.html]
---
...
{{< code lang="php" title="login_session ライブラリ (application/libraries/login_session.php)" >}}
...
Form Validation クラスによる、入力フォーマットの検証にエラーが発生した場合は、`validation_errors()` の表示が行われます。
...
{{< code lang="html" title="login_view ビュー (application/views/login_view.php)" >}}
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
ログインフォームを表示するためには、`https://your.site/user/login` のような URL でアクセスすることにします。
...
{{< code lang="php" title="User コントローラー (application/controllers/user.php)" >}}
<?php
