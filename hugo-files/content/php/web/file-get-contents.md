---
title: "PHPメモ: Web サーバ上のコンテンツを HTTP で取得する (file_get_contents)"
url: "/p/k3nfumx/"
date: "2013-06-11"
tags: ["php"]
aliases: [/php/web/file-get-contents.html]
---
...
{{< code lang="php" title="例: http://example.com/sample.html の内容を取得する" >}}
<?php
