---
title: "Node.jsメモ: npm コマンドで Node.js のパッケージをインストール／アンインストールする (npm install, uninstall)"
url: "p/2dua65s/"
date: "2012-11-27"
tags: ["nodejs"]
aliases: /nodejs/npm/install-package.html
---
...
{{< code lang="console" title="例: socket.io パッケージのインストール" >}}
...
{{< code lang="console" title="例: restify パッケージのインストール" >}}
$ npm install restify
...
{{< code lang="console" title="例: express のバージョン 4.16.4 をインストール" >}}
...
{{< code lang="console" title="例: express のバージョン 4.0.0 以上をインストール" >}}
$ npm install express@">=4.0.0"
{{< /code >}}

{{< code lang="console" title="例: express のバージョン 4.0.0 以上 4.16.4 以下をインストール" >}}
...
パッケージをアンインストールするには、**`npm uninstall`** コマンドを使用します。
