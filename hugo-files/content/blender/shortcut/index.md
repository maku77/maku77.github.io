---
title: "Blenderメモ: Blender の基本操作まとめ"
url: "p/pq6h8q7/"
date: "2018-02-26"
tags: ["blender"]
aliases: [/blender/shortcut/]
---
...
<table class="local-example">
  <tr>
    <td><img src="img-select-mode.png"></td>
    <td><kbd>Ctrl + Tab</kbd>（編集モードのみ）</td>
    <td>メッシュ選択モードの切り替え（頂点／辺／面）</td>
  </tr>
  <tr>
    <td rowspan="2"><img src="img-select-click.svg"></td>
    <td><kbd>右クリック</kbd></td>
    <td>カーソル下の要素を選択</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><img src="img-select-all.svg"></td>
    <td><kbd>A</kbd></td>
    <td>全てを選択／解除 ((De)select All)</td>
  </tr>
  <tr>
    <td rowspan="2"><img src="img-select-border.svg"></td>
  ...
  <tr>
    <td rowspan="2"><img src="img-select-circle.svg"></td>
  ...
  <tr>
    <td rowspan="2"><img src="img-select-region.svg"></td>
  ...
  <tr>
    <td><img src="img-select-inverse.svg"></td>
...
<table class="local-example">
  ...
  <tr>
    <td><img src="img-view-camera.png"></td>
    <td><kbd>0</kbd></td>
    <td>カメラ視点</td>
  </tr>
  <tr>
    <td><img src="img-view-front.png"></td>
    <td><kbd>1</kbd></td><td>前</td>
  </tr>
  <tr>
    <td><img src="img-view-back.png"></td>
    <td><kbd>Ctrl + 1</kbd></td><td>後ろ</td>
  </tr>
  <tr>
    <td><img src="img-view-right.png"></td>
    <td><kbd>3</kbd></td><td>右</td>
  </tr>
  <tr>
    <td><img src="img-view-left.png"></td>
    <td><kbd>Ctrl + 3</kbd></td><td>左</td>
  </tr>
  <tr>
    <td><img src="img-view-top.png"></td>
    <td><kbd>7</kbd></td><td>上</td>
  </tr>
  <tr>
    <td><img src="img-view-bottom.png"></td>
    <td><kbd>Ctrl + 7</kbd></td><td>下</td>
  </tr>
  <tr>
    <td><img src="img-view-persp-ortho.png"></td>
    <td><kbd>5</kbd></td>
    <td>透視投影 ↔︎ 平行投影</td>
  </tr>
  <tr>
    <td><img src="img-view-quad-view.png"></td>
  ...
  <tr>
    <td></td>
    <td><kbd>.</kbd></td>
    <td>選択したオブジェクトにズーム ★ある箇所にフォーカスして編集するときに便利</td>
  </tr>
  <tr>
    <td></td>
...
<table class="local-example">
  ...
  <tr>
    <td><img src="img-manipulator-off.png"><img src="img-manipulator-on.png"></td>
...
<table class="local-example">
  ...
  <tr>
    <td><img src="img-mesh-make-face.svg"></td>
    <td>3 つ以上の頂点を選択して <kbd>F</kbd></td>
    <td>面の作成 (Make Face) ... 選択した辺・頂点を繋ぐように面・辺を作成</td>
  </tr>
  <tr>
    <td><img src="img-mesh-fill.svg"></td>
    <td><kbd>Alt + F</kbd></td>
    <td>面を張る ... 選択した頂点を閉じるように三角形の面を作成</td>
  </tr>
  <tr>
    <td><img src="img-mesh-insert-faces.svg"></td>
    <td><kbd>I</kbd></td>
    <td><a href="/p/pg47dfv/">面を差し込む (Insert Faces)</a></td>
  </tr>
  <tr>
    <td><img src="img-mesh-extrude-region.svg"></td>
    <td><kbd>E</kbd></td>
    <td><a href="/p/ehqbxac/">面の押し出し (Extrude Region)</a></td>
  </tr>
  <tr>
    <td><img src="img-mesh-loopcut.svg"></td>
    <td><kbd>Ctrl + R</kbd></td>
    <td><a href="/p/bjyn3xw/">ループカットとスライド (Loopcut and Slide)</a></td>
  </tr>
  <tr>
    <td><img src="img-mesh-knife.svg"></td>
    <td><kbd>K</kbd> → クリック繰り返し</td>
    <td>ナイフ (Knife)</td>
  </tr>
  <tr>
    <td><img src="img-mesh-subdivide-faces.svg"></td>
    <td><kbd>W</kbd> → <samp>Subdivide</samp></td>
    <td>（面の）細分化 (Subdivide)</td>
  </tr>
  <tr>
    <td><img src="img-mesh-subdivide-edges.svg"></td>
    <td><kbd>W</kbd> → <samp>Subdivide</samp></td>
    <td>（辺の）細分化 (Subdivide)</td>
  </tr>
  <tr>
    <td><img src="img-mesh-connect-path.svg"></td>
    <td><kbd>J</kbd></td>
    <td>頂点の経路を連結 (Connect Vertex Path)<br><small>既存の面を分割</small></td>
  </tr>
  <tr>
    <td><img src="img-mesh-edge-add.svg"></td>
    <td>2 つの頂点を選択して <kbd>F</kbd></td>
    <td>辺の作成<br><small>面を分割したいときは <kbd>J</kbd> を使うこと</small></td>
  </tr>
  <tr>
    <td><img src="img-mesh-merge.svg"></td>
    <td><kbd>Alt + M</kbd></td>
    <td>選択した頂点を結合 (Merge)</td>
  </tr>
  <tr>
    <td><img src="img-mesh-triangulate-faces.svg"></td>
    <td><kbd>Ctrl + T</kbd></td>
    <td>面を三角化 (Triangulate Faces)</td>
  </tr>
  <tr>
    <td><img src="img-mesh-tris-to-quads.svg"></td>
    <td><kbd>Alt + J</kbd></td>
