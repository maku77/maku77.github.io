---
title: "Blenderメモ: オブジェクトを拡大／縮小する (S)"
url: "p/cmqqmge/"
date: "2018-03-18"
tags: ["blender"]
aliases: [/blender/3dview/scale.html]
---
...
中央の白い円をドラッグすると、オブジェクト全体を拡大／縮小することができます。
...
倍率は、拡大／縮小後のオブジェクトのサイズを指定するのではなく、あくまで現在のサイズを基準にして何倍にするかを指定することに注意してください。
サイズを 1/2 にしたいのであれば、0.5 と入力します。

{{< code title="例: オブジェクト全体のサイズを2倍にする" >}}
S 2 Enter
{{< /code >}}

{{< code title="例: オブジェクト全体のサイズを半分にする" >}}
S 0.5 Enter
{{< /code >}}
...
移動操作 (<kbd>G</kbd>) や、回転操作 (<kbd>R</kbd>) と同様に、拡大／縮小操作 (<kbd>S</kbd>) も適用する軸の方向を制限することができます。

{{< code title="例: オブジェクトをZ軸方向に3倍に拡大する" >}}
S Z 3 Enter
{{< /code >}}

{{< code title="例: オブジェクトをZ軸以外の方向（X軸とY軸方向）に3倍に拡大する" >}}
S Shift+Z 3 Enter
{{< /code >}}
...
{{< code title="例: オブジェクトをX軸方向に半分に縮小" >}}
S X / 2 Enter
S X 2 / Enter
S / X 2 Enter
S / 2 X Enter
...
{{< code title="例: 間違った例（1/12 に縮小される）" >}}
S 1 / 2 Enter
{{< /code >}}
