---
title: "Blenderメモ: ループカットとスライドで辺を追加する (Ctrl + R)"
url: "p/bjyn3xw/"
date: "2019-05-06"
tags: ["blender"]
aliases: [/blender/3dview/loopcut.html]
---
...
<kbd>Ctrl + R</kbd> を押して任意の辺にマウスカーソルを合わせると、紫色のラインが表示されるので、その状態で <kbd>左クリック</kbd> するとループカットが実行されます。
