---
title: "Blenderメモ: オブジェクトを移動する (G)"
url: "p/m6s5i2o/"
date: "2018-03-17"
tags: ["blender"]
aliases: [/blender/3dview/move.html]
---
...
オブジェクトを移動しているときに、<kbd>Ctrl</kbd> キーを押しながらマウス移動すると、移動の単位を大きくすることができます（基本的には、水平面などに表示されたグリッドのサイズ単位で動くようになります）。
...
{{< code title="例: Z軸方向に +1 移動させる" >}}
G Z 1 Enter
{{< /code >}}

{{< code title="例: Y軸方向に -0.5 移動させる" >}}
G Y -0.5 Enter
{{< /code >}}
