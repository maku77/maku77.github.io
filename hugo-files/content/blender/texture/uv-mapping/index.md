---
title: "Blenderメモ: UV マッピングの基本"
url: "p/4v6k7yk/"
date: "2018-03-25"
tags: ["blender"]
aliases: [/blender/texture/uv-mapping.html]
---
...
左側に UV/画像エディター、右側に 3D エディターというレイアウトに切り替わります。
...
作成したテクスチャ画像を保存するときは、ベースとなる UV 配置画像のレイヤーは非表示にして書き出します。
...
最後に、UV/画像エディターでマッピングした通りの座標に、テクスチャ画像を適用するための設定を行います。
