---
title: "Blenderメモ: 画面の構成要素を理解する"
url: "p/2kozoid/"
date: "2019-01-26"
tags: ["blender"]
aliases: [/blender/ui/window.html]
---

Blender の画面構成を理解することは、Blender の使い方を効率的に学ぶためのポイントになります。
1つのウィンドウ内にたくさんの部品が並んでいるため、最初はチンプンカンプンになりますが、下記のようにひとつずつ理解していけばとても体系的に構成されていることがわかると思います。
...
{{< image border="true" src="img-window-editors.png" >}}
...
{{< image border="true" src="img-window-headers.png" >}}
...
{{< image border="true" w="500" title="エディタータイプ一覧" src="img-window-editor-type.png" >}}
...
{{< image border="true" w="600" src="img-window-toolshelf1.png" >}}
...
{{< image border="true" w="600" src="img-window-toolshelf2.png" >}}
