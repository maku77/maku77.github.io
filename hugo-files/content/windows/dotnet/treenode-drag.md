---
title: "Windowsメモ: .NET - ツリーノードのドラッグ＆ドロップの流れ"
url: "p/hepcaw7/"
date: "2006-07-01"
tags: ["windows"]
aliases: /windows/dotnet/treenode-drag.html
---
...
{{< code lang="csharp" title="1. ドラッグ開始時のイベントを追加＆実装" >}}
public Form1() {
    ...
...
{{< code lang="csharp" title="2. ドロップを受け入れる許可をする" >}}
public Form1() {
    ...
...
{{< code lang="csharp" title="3. ドロップ可能なアイテムだけを判別して受け入れるようにする" >}}
public Form1() {
    ...
...
{{< code lang="csharp" title="4. ドロップしたときの処理を記述する" >}}
public Form1() {
    ...
