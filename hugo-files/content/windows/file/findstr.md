---
title: "Windowsメモ: findstr でファイル内の文字列を検索する"
url: "p/iuxsf5h/"
date: "2009-11-19"
tags: ["windows"]
aliases: /windows/file/findstr.html
---
...
{{< code title="例: \"aaa bbb ccc\" という文字列を含む行を検索" >}}
C:\> findstr /C:"aaa bbb ccc" input.txt
{{< /code >}}

{{< code title="例: \"aaa\"、\"bbb\"、\"ccc\" の OR 検索" >}}
...
{{< code title="例: \"aaa\" と \"bbb\" の両方を含む行を検索" >}}
...
{{< code title="例: php ファイルの中から、行頭が function で始まる行を検索" >}}
