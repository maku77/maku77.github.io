---
title: "Windowsメモ: コマンドプロンプトからウィンドウサイズを変更する (MODE)"
url: "p/fdsy5gc/"
date: "2018-05-23"
tags: ["windows"]
aliases: /windows/settings/change-window-size.html
---
...
{{< code title="例: コマンドプロンプトのウィンドウサイズを 100 x 10 に変更" >}}
C:\> mode 100,10
{{< /code >}}
...
{{< code title="例: コマンドプロンプトのウィンドウの横幅を最大にまで広げる" >}}
C:\> mode 1000
{{< /code >}}
...
{{< code lang="bat" title="sample.bat（ウィンドウサイズを 100x10、バッファサイズを 3000 に変更）" >}}
mode 100,10
