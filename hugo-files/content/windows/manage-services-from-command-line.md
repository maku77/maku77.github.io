---
title: "Windowsメモ: コマンドラインから Windows サービスを管理する"
url: "p/fsge3yg/"
date: "2005-07-28"
tags: ["windows"]
aliases: /windows/manage-services-from-command-line.html
---
...
{{< code title="例: Perforce Server のサービス情報" >}}
C:\> sc query Perforce
...
C:\> sc config mysql start= demand    # 手動起動
```
