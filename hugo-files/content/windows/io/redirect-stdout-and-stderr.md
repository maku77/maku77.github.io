---
title: "Windowsメモ: 標準出力 (stdout) と標準エラー (stderr) への出力をファイルに保存する"
url: "p/knrzjz9/"
date: "2015-05-21"
lastmod: "2019-04-03"
tags: ["windows"]
aliases: /windows/io/redirect-stdout-and-stderr.html
---
...
{{< code title="例: myprog コマンドの標準出力を stdout.txt へ、標準エラーを stderr.txt へ保存" >}}
...
{{< code title="例: myprog コマンドの標準出力と標準エラーをまとめて log.txt に保存" >}}
C:\> myprog > log.txt 2>&1
{{< /code >}}

ちなみに、Linux の bash で同様のことを行うには、`command >&  log.txt` とします。
...
{{< code lang="bat" title="sample.bat（エラー出力するバッチファイル）" >}}
@echo off
...
{{< code title="例: コマンド myprog のエラーを表示しない" >}}
C:\> myprog 2> nul
{{< /code >}}
