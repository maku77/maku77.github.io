---
title: "HTML/CSSメモ: SNS ボタンをきれいに並べる"
url: "p/jie63z4/"
date: "2017-11-02"
lastmod: "2020-04-05"
...
tags: ["html", "css"]
aliases: /web/button/sns-buttons.html
---
...
SNS シェア用のボタンを設置するときは、ガイドラインに沿った色を使って作成するようにしましょう。
...
<div>（{{< file src="sns-buttons-demo1.html" caption="デモページを開く" >}}）</div>
...
<div>（{{< file src="sns-buttons-demo2.html" caption="デモページを開く" >}}）</div>
