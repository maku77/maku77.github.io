---
title: "HTML/CSSメモ: 独自の入力フォーマットを指定する（pattern 属性）"
url: "p/hgeioh3/"
date: "2017-12-10"
tags: ["html"]
aliases: /web/form/pattern.html
---
...
{{< code lang="html" title="例: HTML の form 要素抜粋" >}}
<label>
  ユーザーID:
...
<div>（{{< file src="pattern-demo.html" caption="デモページを開く" >}}）</div>
...
<div>（{{< file src="pattern-demo2.html" caption="デモページを開く" >}}）</div>
