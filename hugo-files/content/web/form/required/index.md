---
title: "HTML/CSSメモ: 入力必須の入力フォームを指定する（required 属性）"
url: "p/3pzh4nu/"
date: "2017-12-10"
description: "入力フォームの要素に、required 属性を指定しておくと、その要素が入力必須であることを示すことができます。"
tags: ["html"]
aliases: /web/form/required.html
---
...
<div>（{{< file src="required-demo.html" caption="デモページを開く" >}}）</div>
...
<div>（{{< file src="required-demo2.html" caption="デモページを開く" >}}）</div>
