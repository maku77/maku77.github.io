...
<iframe class="xHtmlDemo" src="demo1.html"></iframe>
<div>（{{< file src="demo1.html" caption="デモページ１を開く" >}}）</div>
...
<iframe class="xHtmlDemo" src="demo2.html"></iframe>
<div>（{{< file src="demo2.html" caption="デモページ２を開く" >}}）</div>

ブラウザのフォントサイズ設定を変更したときに、上記のデモページのフォントサイズが変更されることを確認してみてください。
