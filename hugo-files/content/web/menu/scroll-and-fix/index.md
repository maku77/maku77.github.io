---
title: "HTML/CSSメモ: ある位置までスクロールしたら固定されるメニューを作成する"
url: "p/df68rym/"
date: "2018-05-15"
tags: ["css"]
aliases: /web/menu/scroll-and-fix.html
---
...
{{< file src="scroll-and-fix-demo1-1.html" caption="デモページを開く" >}}
...
{{< file src="scroll-and-fix-demo1-2.html" caption="デモページを開く" >}}
...
{{< file src="scroll-and-fix-demo1-3.html" caption="デモページを開く" >}}
...
こうしておけば、ページをスクロールしている最中に、小さい方のコンテンツはすべて表示し続けることができます。


### サイドバーが本文より小さいが、ウィンドウに収まらない場合

{{< image src="img-003.svg" >}}
...
{{< file src="scroll-and-fix-demo2.html" caption="デモページを開く" >}}
