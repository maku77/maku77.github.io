...
{{< file src="accordion-demo.html" caption="デモページを開く" >}}
...
直後の要素を指定するために、[隣接セレクタ (`+`) の記法](/p/dnyt894/)を使用しています。
...
{{< file src="accordion-demo2.html" caption="デモページを開く" >}}
