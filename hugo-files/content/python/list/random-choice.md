---
title: "Pythonメモ: リスト／タプル内の要素をランダムで取得する (random.choice, random.choices, random.sample)"
url: "p/nwo79zc/"
date: "2018-11-02"
tags: ["python"]
aliases: ["/python/list/random-choice.html"]
---
...
## リストからランダムに 1 つずつすべて取り出す

リスト内の要素をランダムな順番で 1 つずつ取り出したいときは、単純に **`random.shuffle`** したリストをループ処理すればよいです。
