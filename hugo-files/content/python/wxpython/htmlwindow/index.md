---
title: "Pythonメモ: wxPython - HtmlWindow（HTML ウィンドウ）"
url: "p/rktuz7x/"
date: "2007-04-26"
tags: ["python"]
aliases: /python/wxpython/htmlwindow.html
---
...
`wx.html.HtmlWindow` 上でのユーザ入力を処理したい場合は、`HtmlWindow` のサブクラスを作成し、`OnLinkClicked(link)` などのハンドラメソッドをオーバーライドします。
...
{{< code lang="html" title="page1.html" >}}
<TITLE>Page1</TITLE>
<H1>Page1</H1>
<A href="page2.html">Page2</A>
{{< /code >}}

{{< code lang="html" title="page2.html" >}}
<TITLE>Page2</TITLE>
<H1>Page2</H1>
