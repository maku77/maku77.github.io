---
title: "Pythonメモ: wxPython - ListBox（リストボックス）"
url: "p/pc4be59/"
date: "2007-03-08"
tags: ["python"]
aliases: /python/wxpython/listbox.html
---
...
項目の選択状態が変化したことを知るには、`wx.EVT_LISTBOX` イベントを処理します。項目をダブルクリックした場合は `wx.EVT_LISTBOX_DCLICK` イベントが発生します。
