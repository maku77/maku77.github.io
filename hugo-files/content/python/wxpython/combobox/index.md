---
title: "Pythonメモ: wxPython - ComboBox（コンボボックス）"
url: "p/kcgbgcy/"
date: "2007-04-10"
tags: ["python"]
aliases: /python/wxpython/combobox.html
---
...
`wx.Choice` のサブクラスである `wx.ComboBox` は、テキスト入力領域と、プルダウンからの選択機能を備えたコンボ・ボックスを提供します。
