---
title: "Pythonメモ: wxPython - SplitterWindow（スプリッターウィンドウ）"
url: "p/vorgsyf/"
date: "2007-04-06"
tags: ["python"]
aliases: /python/wxpython/splitterwindow.html
---
...
{{< code lang="python" title="wx.SplitterWindow コンストラクタ" >}}
...
{{< code lang="python" title="サンプルコード（ウィンドウを左右に分割）" >}}
import wx
...
このメソッドによってサブ・ウィンドウを入れ換えた場合、`winOld` で指定したサブ・ウィンドウは表示されなくなりますが、インスタンス自体は破棄されないので、明示的に `Destroy()` メソッドを呼び出してインスタンスを破棄する必要があります。
