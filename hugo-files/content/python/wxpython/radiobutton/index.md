---
title: "Pythonメモ: wxPython - RadioButton（ラジオボタン）"
url: "p/rknynxq/"
date: "2007-04-09"
tags: ["python"]
aliases: /python/wxpython/radiobutton.html
---
...
{{< code lang="python" title="wx.RadioButton コンストラクタ" >}}
...
`wx.RadioButton` のコンストラクタの `style` パラメータで、`wx.RB_GROUP` フラグを設定すると、そのラジオボタンから新しいグループに追加されます。
...
{{< code lang="python" title="wx.RadioBox コンストラクタ" >}}
