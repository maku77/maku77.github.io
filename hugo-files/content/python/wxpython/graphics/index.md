---
title: "Pythonメモ: wxPython によるグラフィックス処理を理解する"
url: "p/bbta2ho/"
date: "2007-04-18"
tags: ["python"]
aliases: /python/wxpython/graphics.html
---
...
```python
wx.Image#GetWidth() -> int
wx.Image#GetHeight() -> int
wx.Image#GetSize() -> Size
```
...
`r`, `g`, `b` パラメータには 0 ～ 255 の範囲で Red, Green, Blue の値を指定します。
...
{{< code lang="python" title="paintBuffer.py" >}}
import wx
