---
title: "Pythonメモ: wxPython によるウィンドウ表示の基本"
url: "p/tvwz23r/"
date: "2007-02-06"
tags: ["python"]
aliases: /python/wxpython/basic.html
---
...
`wx.App` インスタンスが生成された後で呼び出される `wx.App#OnInit()` をオーバーライドして、メインウィンドウ (`wx.Frame`) を作成します。
...
`wx.App#OnInit()` の戻り値では通常 `True` を返しますが、リソースの初期化失敗などでアプリケーションを継続できない場合は、`False` を返すことでアプリケーションを終了させることができます。
