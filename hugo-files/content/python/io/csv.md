---
title: "Pythonメモ: CSV ファイルや TSV ファイルを読み込む (csv.reader)"
url: "p/cfqer8d/"
date: "2013-05-09"
lastmod: "2019-04-09"
tags: ["python"]
aliases: /python/io/csv.html
---
...
{{< code lang="csv" title="入力ファイル (input.csv)" >}}
AAA, 100
BBB, 200
CCC, 300
{{< /code >}}
...
1 行目がヘッダになっている CSV や TSV ファイルを読み込むには、下記のように **`next`** を使って 1 行目だけを別に処理します。
