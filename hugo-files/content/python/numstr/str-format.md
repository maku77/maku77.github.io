---
title: "Pythonメモ: 文字列の中で変数を展開する（書式文字列によるフォーマット） (str#format, %演算子)"
url: "p/nmz89p9/"
date: "2019-06-04"
tags: ["python"]
aliases: ["/python/numstr/str-format.html"]
---
...
`%` 演算子を使ったほうが簡潔に書けることが多いので、残したいという要望が多かったのでしょう。
