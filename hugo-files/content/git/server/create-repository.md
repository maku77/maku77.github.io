---
title: "Gitメモ: 共有リポジトリを作成する (git init --bare, git clone --bare)"
url: "p/yaocjjs/"
date: "2014-05-13"
tags: ["git"]
aliases: [/git/server/create-repository.html]
---
...
`public_repo.git` から clone したのと同様に振る舞ってほしいので、`origin` というリモートトラッキングブランチ名で `public_repo.git` を指し示すように設定しておくとよいでしょう。
