---
title: "Gitメモ: git-daemon でリポジトリを読み取り専用で公開する"
url: "p/kax48rz/"
date: "2014-05-14"
tags: ["git"]
aliases: [/git/server/git-daemon.html]
---
...
これらのリポジトリをすべて公開するには、以下のように git-daemon を起動します。
...
$ git clone git://192.168.0.1/repo2.git  #==> NG (not exported)
```
