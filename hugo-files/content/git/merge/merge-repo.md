---
title: "Gitメモ: 別の Git リポジトリの内容を強引にマージする"
url: "p/odgmdp2/"
date: "2020-02-18"
tags: ["git"]
aliases: [/git/merge/merge-repo.html]
---
...
これはある意味しょうがないので、`git status` や `git diff` でコンフリクトしているファイルを確認しながら修正し、コンフリクトをすべて取り除いたらコミット＆プッシュしてマージ完了です。
