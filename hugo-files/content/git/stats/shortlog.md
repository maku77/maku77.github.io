---
title: "Gitメモ: ユーザーごとのコミット統計を出力する (git shortlog)"
url: "p/ocva5fh/"
date: "2018-12-04"
tags: ["git"]
aliases: [/git/stats/shortlog.html]
---
...
{{< code lang="console" title="例: 1年前から 2018-12-01 の間でコミットの多い人を調べる" >}}
...
`git shortlog` による統計情報では、異なるユーザ名やメールアドレスを使ってコミットされたものは別々に集計されてしまいます。
