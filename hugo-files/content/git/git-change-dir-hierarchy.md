---
title: "Gitメモ: Git やり直し: コミット履歴を書き換えてディレクトリ階層を変更する (git filter-branch)"
url: "p/iut5h68/"
date: "2015-06-29"
tags: ["git"]
aliases: [/git/git-change-dir-hierarchy.html]
---
...
そのため、`git filter-branch` は、[リポジトリの移行](/p/bfxgbf4/)時などに限定して実行すべきです。
