---
title: "Gitメモ: GitLab のデータをバックアップ／リストアする"
url: "p/df778jg/"
date: "2014-05-17"
tags: ["git"]
aliases: [/git/gitlab/backup-and-restore.html]
---
...
ファイル名のプレフィックスとしてタイムスタンプが付くため、前回のバックアップファイルが上書きされることはありません。
...
{{< code lang="shell" title="gitlab-backup.sh" >}}
#!/bin/bash
sudo gitlab-rake gitlab:backup:create
mkdir -p ~/gitlab_backup
