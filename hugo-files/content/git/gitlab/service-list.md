---
title: "Gitメモ: 起動中の GitLab 関連サービスを調べる"
url: "p/5672eis/"
date: "2014-05-15"
tags: ["git"]
aliases: [/git/gitlab/service-list.html]
---

`gitlab-ctl service-list` や `gitlab-ctl status` コマンドを使用すると、起動している GitLab 関連のサービスの一覧や状態を確認できます。

{{< code lang="console" title="GitLab 関連サービスの一覧を表示" >}}
...
{{< code lang="console" title="GitLab 関連サービスの動作状態を確認" >}}
