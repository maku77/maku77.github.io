---
title: "Gitメモ: GitLab が使用する Unicorn 用のポート番号を変更する"
url: "p/fhyfx7p/"
date: "2014-05-16"
tags: ["git"]
aliases: [/git/gitlab/unicorn-port.html]
---
...
{{< code lang="ruby" title="/var/opt/gitlab/gitlab-rails/etc/unicorn.rb" >}}
...
{{< code lang="yaml" title="/opt/gitlab/embedded/service/gitlab-shell/config.yml" >}}
gitlab_url: "http://localhost:8080"
{{< /code >}}

上記の `8080` というところを `8090` などに変更します。

あとは、GitLab のサービス群を再起動すれば設定が反映されます。
