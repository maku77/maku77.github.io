---
title: "C++メモ: 組み合わせ (combination) を作成する"
url: "p/b4n3h59/"
date: "2012-03-13"
tags: ["cpp"]
aliases: /cpp/number/combination.html
---


C++ で順列 (permutation) を生成するには `std::next_permutation()` を使えばよいのですが、組み合わせ (combination) を生成するものがないので作っておきます。


再帰を使わずに組み合わせを作成する例
----

{{< code lang="cpp" title="combination.cpp" >}}
#include <iostream>
#include <vector>
using namespace std;
...
上記のコードでは、`[1,2,3,4,5]` というリストから 3 つ選ぶ組み合わせを列挙しています。
結果は、`[1,2,3][1,2,4][1,2,5][1,3,4][1,3,5][1,4,5][2,3,4][2,3,5][2,4,5][3,4,5]` のようになります。
...
{{< code lang="cpp" title="combination2.cpp" >}}
#include <iostream>
#include <vector>
using namespace std;
