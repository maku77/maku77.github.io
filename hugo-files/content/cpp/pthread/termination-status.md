---
title: "C++メモ: pthread のスレッドの終了ステータスを取得する"
url: "p/waq5f9y/"
date: "2010-11-07"
tags: ["cpp"]
aliases: /cpp/pthread/termination-status.html
---

`pthread_join` で、あるスレッドの終了を待機する際に、第 2 引数でスレッドルーチンからの戻り値を受け取ることができます。
...
`pthread_exit()` を使用してスレッドを終了した場合も、その引数で戻り値を指定することができます。

```cpp
void pthread_exit(void *value)
```

{{< code lang="cpp" title="サンプルコード" >}}
#include <stdio.h>
#include <pthread.h>
