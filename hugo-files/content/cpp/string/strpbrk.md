---
title: "C++メモ: 文字列の中に指定した文字列の中のいずれかの文字が含まれているか調べる (`strpbrk`)"
url: "p/u84nydn/"
date: "2011-03-21"
tags: ["cpp"]
aliases: /cpp/string/strpbrk.html
---
...
例えば、以下のようにすると、入力されたテキストの中に不正な文字が含まれていないかチェックできます。
...
if (strpbrk(input, invalidChars)) {
   std::cout << "including an invalid character" << std::endl;
}
```
