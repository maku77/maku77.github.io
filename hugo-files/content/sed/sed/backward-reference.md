---
title: "sed/awkメモ: sed で置換するときに後方参照を使用する"
url: "/p/irnh24x/"
date: "2009-04-05"
tags: ["sed/awk"]
aliases: [/sed/sed/backward-reference.html]
---
...
{{< code lang="console" title="例: 日付らしき文字列 (YYYY-MM-DD) を [ と ] で囲む" >}}
...
{{< code lang="console" title="例: パターンに一致した２つの文字列の前後を入れ替える" >}}
