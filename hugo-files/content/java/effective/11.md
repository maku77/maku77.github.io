---
title: "Javaメモ: clone を注意してオーバライドする"
url: "p/rtsoitj/"
date: "2016-07-08"
tags: ["java"]
aliases: ["/java/effective/11.html"]
---
...
サブクラスで `Cloneable` インタフェースが `implements` されているかどうかによって、この `Object#clone()` の振る舞いが変化するように実装されています。

{{< code title="Object#`clone`() の実装" >}}
class Object {
    ...
