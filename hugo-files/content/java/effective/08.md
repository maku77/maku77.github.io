---
title: "Javaメモ: equals をオーバーライドする時は一般契約に従う"
url: "p/exiwzrf/"
date: "2016-04-22"
tags: ["java"]
aliases: ["/java/effective/08.html"]
---
...
{{< code lang="java" title="Object#`equals`(`Object`) の実装" >}}
...
多くの場合は、自分自身のクラスの型と同じであるかを調べればよいのですが、このクラスがあるインタフェースを実現するための具象クラスである場合は、等しいインタフェースを実装したオブジェクトが渡されたかどうかを調べるということもあり得ます（この場合も `instanceof` で OK）。
...
→ [equals をオーバーライドする時は、常に hashCode をオーバーライドする](/p/ahoova6/)
