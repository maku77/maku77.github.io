---
title: "Javaメモ: 廃れたオブジェクト参照を取り除く"
url: "p/frvttgs/"
date: "2016-02-18"
tags: ["java"]
aliases: ["/java/effective/06.html"]
---
...
キー＆バリュー形式のキャッシュを実装する場合は、`WeakHashMap` を利用することで、クライアント側で必要とされなくなったキーに対するオブジェクト参照を自動的に無効にすることができます。
