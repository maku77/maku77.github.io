---
title: "Javaメモ: Java から SQLite を扱えるようにする"
url: "p/tb479oj/"
date: "2010-08-08"
tags: ["java"]
aliases: ["/java/jdbc-sqlite-driver.html"]
---
...
* https://www.xerial.org/trac/Xerial/wiki/SQLiteJDBC
...
Eclipse で SQLite JDBC Driver を使ったプログラミングを行うには、Java プロジェクトに `sqlite-jdbc-x.x.x.jar` へのクラスパスを追加します。
