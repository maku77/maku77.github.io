---
title: "Javaメモ: Java でカスタムアノテーションを作成する"
url: "p/nvwk62g/"
date: "2015-10-05"
tags: ["java"]
aliases: ["/java/custom-annotation.html"]
---
...
{{< code lang="java" title="NonNull.java（アノテーションの定義例）" >}}
...
{{< code lang="java" title="Hello.java（アノテーションの使用例）" >}}
package com.example;
