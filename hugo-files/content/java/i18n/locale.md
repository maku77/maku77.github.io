---
title: "Javaメモ: Java アプリケーションの国際化 (i18n) と Locale クラス"
url: "p/3jj68m7/"
date: "2010-05-16"
tags: ["java"]
aliases: ["/java/i18n/locale.html"]
---
...
{{< code title="strings_en_US.properties" >}}
hello = Hello!
{{< /code >}}

`ResourceBundle.getBundle()` で指定した `Locale` に対応するプロパティファイルが見つからない場合は、デフォルトのプロパティファイルがロードされます。
...
{{< code title="strings.properties" >}}
hello = Default Hello!
{{< /code >}}

{{< code title="strings_jp.properties" >}}
hello = \u3053\u3093\u306b\u3061\u306f\uff01
{{< /code >}}
