---
title: "Javaメモ: アノテーションとは"
url: "p/su4opzc/"
date: "2006-02-06"
tags: ["java"]
aliases: ["/java/what-is-annotation.html"]
---

Java 1.5 Tiger で、メソッドなどに付加情報を与える仕組みとして **Annotation** が導入されました。
...
メソッドを定義するときに **`@Override`** を付加することで、スーパークラスのメソッドをオーバライドしているという意思をコンパイラに伝えます。
...
一方で `Deprecated` アノテーションは、コンパイル時に非推奨要素を使っているかを検出して警告します。
