---
title: "Javaメモ: Swing - JEditorPane で HTML コンテンツを表示する"
url: "p/nvyjnkj/"
date: "2011-02-06"
tags: ["java"]
aliases: ["/java/swing/widget/jeditorpane1.html"]
---
...
{{< code lang="java" title="JEditorPane のコンストラクタ" >}}
JEditorPane()
...
JEditorPane でローカルファイルをロードするには、以下のようにしないといけないようです（こうしないと URL がうまく解決できません）。
