---
title: "Javaメモ: Swing - JTree で指定したノードを選択する"
url: "p/ody2qf8/"
date: "2011-02-12"
tags: ["java"]
aliases: ["/java/swing/widget/jtree-select-node.html"]
---
...
フォーカスを移動する必要がなく、指定したノードがユーザーに見える状態になるだけでよい場合は、以下のメソッドを使用します。
このメソッドを使用する場合は、JTree が JScrollPane に含まれている必要があります。
