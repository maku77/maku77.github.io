---
title: "Javaメモ: Swing - JList で選択されている項目を取得する"
url: "p/jodffpp/"
date: "2011-02-19"
tags: ["java"]
aliases: ["/java/swing/widget/jlist-get-selection.html"]
---
...
JList の複数の項目が選択された状態で、`getSelectedIndex`、`getSelectedValue` を実行すると、選択されている項目の中で最初の項目のインデックスや値が返されます。
