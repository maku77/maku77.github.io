---
title: "Javaメモ: Swing - JTree でツリービューを作成する"
url: "p/p8zwibx/"
date: "2011-02-11"
tags: ["java"]
aliases: ["/java/swing/widget/jtree.html"]
---
...
DefaultMutableTreeNode クラスには、子ノードを追加する `add()` メソッドが定義されており、このメソッドを使って、階層構造を作ることができます。
