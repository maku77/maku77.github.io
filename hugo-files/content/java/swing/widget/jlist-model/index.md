---
title: "Javaメモ: Swing - JList で扱えるモデルクラスを作成する"
url: "p/hcngbie/"
date: "2011-01-23"
tags: ["java"]
aliases: ["/java/swing/widget/jlist-model.html"]
---
...
そのようなケースでは、`ListModel` インタフェースの空実装を提供する `javax.swing.AbstractListModel` を継承してモデルクラスを作成するとよいでしょう。
