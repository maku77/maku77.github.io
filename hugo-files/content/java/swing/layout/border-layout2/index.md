---
title: "Javaメモ: Swing - BorderLayout で中央に配置するコンポーネントのデフォルトサイズを設定する"
url: "p/6oh7few/"
date: "2011-01-15"
tags: ["java"]
aliases: ["/java/swing/layout/border-layout2.html"]
---
...
ただし、JFrame の `pack()` メソッドを呼んだ時点では、中央のコンポーネントは preferred size に設定されるため、ほとんどの場合デフォルトでは小さく表示されます。
