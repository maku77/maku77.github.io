---
title: "Javaメモ: Swing - BoxLayout で左寄せ／中央寄せ／右寄せ表示する"
url: "p/jjujyf9/"
date: "2011-01-09"
tags: ["java"]
aliases: ["/java/swing/layout/box-layout2.html"]
---
...
Java Tutorial の中では、BoxLayout で alignment を指定する場合には、すべてのコンポーネントに対して同じ値を設定することを推奨しています。
