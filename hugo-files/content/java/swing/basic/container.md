---
title: "Javaメモ: Swing - Container と JComponent と JFrame の関係"
url: "p/wkaidfg/"
date: "2011-01-09"
tags: ["java"]
aliases: ["/java/swing/basic/container.html"]
---
...
例えば、下記のように各種コンポーネントを直接配置していくことができます（`getContentPane()` で content pane を取得する必要がない）。
