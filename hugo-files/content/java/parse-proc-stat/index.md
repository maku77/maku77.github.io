---
title: "Javaメモ: Java で Linux の CPU 使用率を調べる"
url: "p/kgnf5i4/"
date: "2012-09-21"
tags: ["java"]
aliases: ["/java/parse-proc-stat.html"]
---
...
- **nice**: nice による優先度変更処理に使用された CPU 時間
- **system**: カーネルが使用した CPU 時間
- **idle**: Idle 時間
...
- [LinuxProcStat.java](LinuxProcStat.java)
- [Main.java](Main.java)
