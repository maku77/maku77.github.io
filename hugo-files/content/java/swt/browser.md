---
title: "Javaメモ: SWT - ブラウザウィジェット (Browser) で HTML を表示する"
url: "p/7tfudc3/"
date: "2010-11-24"
tags: ["java"]
aliases: ["/java/swt/browser.html"]
---
...
Windows ではもちろん使えるし、Mac OS X でも最近デフォルトで使用できるようになったみたいです（Snow Leopard でも使用できることを確認済み）。
