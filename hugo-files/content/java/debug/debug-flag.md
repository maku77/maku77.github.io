---
title: "Javaメモ: DEBUG フラグでログ出力を ON/OFF するときは、呼び出し側で if 分岐すること"
url: "p/q42s87s/"
date: "2014-08-25"
tags: ["java"]
aliases: ["/java/debug/debug-flag.html"]
---
...
{{< code lang="console" title="GoodClass の逆アセンブル結果" >}}
$ javap -c GoodClass
...
{{< code lang="console" title="BadClass の逆アセンブル結果" >}}
$ javap -c BadClass
