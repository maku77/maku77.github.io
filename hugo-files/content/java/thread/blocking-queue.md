---
title: "Javaメモ: BlockingQueue を使ってスレッド間の通信を行う"
url: "p/gz5c3cx/"
date: "2014-06-29"
tags: ["java"]
aliases: ["/java/thread/blocking-queue.html"]
---

参考: [コレクションクラスのまとめ](/p/djcjgem/)
...
`BlockingQueue` の実装にはいくつかありますが（[リンク](/p/djcjgem/)参照）、ここではリンクドリストベースの実装である `LinkedBlockingQueue` を使っています。
