---
title: "Javaメモ: Lock と Condition による条件ごとのスレッド待機"
url: "p/h5y2spb/"
date: "2014-08-20"
tags: ["java"]
aliases: ["/java/thread/lock-and-condition.html"]
---
...
このサンプルでは、バッファクラスへの `put()` と `take()` を同じオブジェクトでロックし、その中で、バッファが空である通知、バッファが満杯である通知を同時に使用しています。
