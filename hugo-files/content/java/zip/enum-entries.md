---
title: "Javaメモ: Zip ファイル内の要素（ファイルとディレクトリ）を列挙する"
url: "p/46p2ir5/"
date: "2016-11-21"
tags: ["java"]
aliases: ["/java/zip/enum-entries.html"]
---
...
{{< code lang="java" title="\"sample.zip\" という Zip ファイルの要素を列挙する" >}}
...
Java 1.8 以降は、`Stream<ZipEntry>` を返す `ZipFile#stream()` メソッドを使用すると、ループ処理をよりシンプルに記述することができます。
