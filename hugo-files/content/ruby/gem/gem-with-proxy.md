---
title: "Rubyメモ: プロキシ経由で gem コマンドを利用する"
url: "p/gsmh9o2/"
date: "2015-10-15"
tags: ["ruby"]
aliases: ["/ruby/gem/gem-with-proxy.html"]
---

`gem` コマンドはインターネット上のサーバーから Ruby のパッケージをダウンロードしますが、プロキシ環境下で接続がうまくいかない場合は下記のようなエラーが発生します。
