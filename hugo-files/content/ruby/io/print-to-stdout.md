---
title: "Rubyメモ: 標準出力へ出力する (puts/print/printf)"
url: "p/a2zcbyr/"
date: "2011-10-01"
tags: ["ruby"]
aliases: ["/ruby/io/print-to-stdout.html"]
---
...
文字列をダブルクォーテーションで囲むと、変数展開を行って出力できます。
...
以下のようにカンマで引数を区切ると、`puts` の場合は各値が改行付きで出力され、`print` の場合は連結されて出力されます。
