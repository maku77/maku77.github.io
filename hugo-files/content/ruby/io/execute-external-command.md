---
title: "Rubyメモ: 外部プログラムを呼び出す"
url: "p/85axqoj/"
date: "2011-07-29"
tags: ["ruby"]
aliases: ["/ruby/io/execute-external-command.html"]
---
...
{{< code lang="ruby" title="ruby_version.rb" >}}
system 'ruby -v'
{{< /code >}}
...
{{< code lang="ruby" title="my_ls.rb" >}}
Process.exec('ls', *ARGV)
{{< /code >}}

自分自身のプロセスで外部プログラムを実行すれば、その実行を `Ctrl-C` で強制終了できます。
（ただし、「MSDOS 環境の場合、command はサブシェル経由で実行されます」という記載がありました。
結局 Windows の場合は別のプロセスが起動してしまうようです。）
