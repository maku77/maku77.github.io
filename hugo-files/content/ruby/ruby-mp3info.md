---
title: "Rubyメモ: ruby-mp3info で MP3 ファイルのタグ情報を取得／修正する"
url: "p/25f969i/"
date: "2015-10-28"
tags: ["ruby"]
aliases: ["/ruby/ruby-mp3info.html"]
---
...
ファイルに、ID3v1 と ID3v2 の両方の情報がある場合は、ID3v2 の情報が優先的に取得されます（一般的な音楽プレーヤーと同じ振る舞いです）。
`Mp3Info#tag` で参照可能な情報は、ID3v1 の頃から定義されていたものに限られるため、下記のような情報に限られています。
...
{{< code lang="ruby" title="update-mp3-info.rb" >}}
require 'mp3info'
