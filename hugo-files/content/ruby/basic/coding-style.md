---
title: "Rubyメモ: Ruby のコーディングスタイル"
url: "p/7wv9hrf/"
date: "2003-10-14"
tags: ["ruby"]
aliases: ["/ruby/basic/coding-style.html"]
---
...
{{< code lang="ruby" title="net/http/digest_auth.rb" >}}
...
クラスではなくモジュールを提供している場合は、例えば下記のようなファイルになります。

{{< code lang="ruby" title="foo/bar/my_module.rb" >}}
module Foo
  module Bar
    module MyModule
      def self.my_method
