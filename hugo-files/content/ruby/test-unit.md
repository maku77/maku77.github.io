---
title: "Rubyメモ: test-unit によるユニットテスト"
url: "p/wshqogt/"
date: "2015-11-21"
tags: ["ruby"]
aliases: ["/ruby/test-unit.html"]
---
...
{{< code lang="ruby" title="counter.rb" >}}
class Counter
  def initialize
    @cnt = 0
  end
...
下記の `CounterTest` クラスは、この `Counter` クラスをテストするためのコードです。
同じディレクトリに `counter.rb` ファイルが存在すると仮定して、`require './counter'` とロードしています。

{{< code lang="ruby" title="counter_test.rb" >}}
require 'test/unit'
