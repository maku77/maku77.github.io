---
title: "Rubyメモ: 配列に要素を追加する"
url: "p/76ga4od/"
date: "2011-10-10"
tags: ["ruby"]
aliases: ["/ruby/array/add-element.html"]
---
...
複数の値を一度に追加したい場合は、単純にカンマで区切って並べます（配列を渡してしまうと、要素として 1 つの配列が追加されてしまうので注意）。
...
`[]` 演算子に負のインデックスを指定した場合は、`insert` メソッドで負のインデックスを指定した場合よりも、挿入位置が 1 つ前にずれます。
