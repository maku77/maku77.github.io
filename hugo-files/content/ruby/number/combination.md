---
title: "Rubyメモ: 組み合わせ (combination) を作成する"
url: "p/ef785b3/"
date: "2011-12-23"
tags: ["ruby"]
aliases: ["/ruby/number/combination.html"]
---

## Array#combination() を使って組み合わせを作成する

Ruby の `Array#combination` メソッドは、与えられた配列要素の組み合わせ (Combination) を作成します。
...
自力で `combination` を実装する場合は、以下のような単純なバックトラック（再帰）で実装できます。
