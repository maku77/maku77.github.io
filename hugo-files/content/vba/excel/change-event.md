---
title: "VBAメモ: Excel のセルの内容が変更されたときのイベントをハンドルする"
url: "p/obputmr/"
date: "2018-04-16"
tags: ["vba"]
aliases: /vba/excel/change-event.html
---
...
変更されたセルの行番号は `Range.Row` プロパティ、列番号は `Range.Column` プロパティで参照することができるので、次のように書くこともできます。
