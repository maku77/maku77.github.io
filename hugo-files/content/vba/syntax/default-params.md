---
title: "VBAメモ: デフォルト引数や可変長引数を持つ関数を定義する (Optional, ParamArray)"
url: "p/rtcyqsa/"
date: "2018-04-17"
tags: ["vba"]
aliases: /vba/syntax/default-params.html
---
...
可変長パラメータ (`ParamArray`) として定義されたパラメータが、関数の呼び出し時に省略されたかどうかは、次のように **`UBound`** によるイディオムで調べることができます。
