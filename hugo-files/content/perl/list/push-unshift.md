---
title: "Perlメモ: 配列に要素を追加する／取り出す"
url: "p/oqbsh76/"
date: "2008-02-28"
tags: ["perl"]
aliases: ["/perl/list/push-unshift.html"]
---
...
{{< code lang="perl" title="配列の末尾／先頭への要素の追加" >}}
push @arr, 10;         # 配列の末尾へ 10 を追加
unshift @arr, 10;      # 配列の先頭へ 10 を追加
{{< /code >}}

{{< code lang="perl" title="配列の末尾／先頭からの要素の取り出し" >}}
...
{{< code lang="perl" title="例: 指定した位置（第２引数）から、指定した数（第３引数）の要素を削除する" >}}
@arr1 = ('1', '2', '3', '4', '5');
