---
title: "Perlメモ: Perl のマニュアルページを表示する (`perldoc`)"
url: "p/dste2y2/"
date: "2008-04-30"
tags: ["perl"]
aliases: ["/perl/misc/perldoc.html"]
---
...
`perldoc` コマンドに **`-l`** オプションを付けると、検索したディレクトリは表示せずに、実際に参照するファイル名が 1 つだけ表示されます。
...
{{< code title="正規表現のマニュアル" >}}
$ perldoc perlre
$ perldoc perlretut
$ perldoc perlrequick
{{< /code >}}

{{< code title="Pod (plain-old documentation) フォーマットのマニュアル" >}}
$ perldoc perlpod
{{< /code >}}

{{< code title="モジュールのインストールに関するマニュアル (CPAN)" >}}
$ perldoc perlmodinstall
{{< /code >}}

{{< code title="モジュールの書き方に関するマニュアル" >}}
$ perldoc perlmod
$ perldoc perlmodlib
{{< /code >}}

{{< code title="プラグマ (pragma) の一覧を調べる" >}}
$ perldoc perlmodlib
{{< /code >}}

{{< code title="組み込み変数に関するマニュアル" >}}
$ perldoc perlvar
{{< /code >}}

{{< code title="組み込み演算子（結合と優先順位）、組み込み関数に関するマニュアル" >}}
$ perldoc perlop
$ perldoc perlfunc
{{< /code >}}

{{< code title="Perl のコマンドラインオプションに関するマニュアル" >}}
$ perldoc perlrun
{{< /code >}}
