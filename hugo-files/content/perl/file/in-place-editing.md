---
title: "Perlメモ: 読み込んでいるファイルの内容を直接変更する（書き戻し編集: in-place editing）"
url: "p/ucsqmtq/"
date: "2008-03-24"
tags: ["perl"]
aliases: ["/perl/file/in-place-editing.html"]
---
...
{{< code lang="perl" title="replace.pl" >}}
...
{{< code lang="console" title="input.txt 内のテキストを置換する（Before → After）" >}}
