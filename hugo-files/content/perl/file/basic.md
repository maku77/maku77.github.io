---
title: "Perlメモ: ファイルのオープン・クローズと読み書きの基本"
url: "p/fhzy25i/"
date: "2008-03-24"
tags: ["perl"]
aliases: ["/perl/file/basic.html"]
---
...
{{< code lang="perl" title="例: IO::File オブジェクトによるファイル書き込み" >}}
use IO::File;
...
{{< code lang="perl" title="例: IO::File オブジェクトによるファイル読み込み" >}}
use IO::File;
