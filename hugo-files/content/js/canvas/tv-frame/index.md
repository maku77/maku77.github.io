---
title: "JavaScriptメモ: HTML5 Canvas のまわりにテレビの枠画像を表示してそれっぽく見せる"
url: "p/bjvoaut/"
date: "2018-03-06"
tags: ["javascript"]
aliases: [/js/canvas/tv-frame.html]
---

ここでは、次のようなテレビ画像のディスプレイ領域に、canvas 要素で描画するようにしてみます。

{{< image w="400" src="img-tv-frame.png" >}}
...
canvas 要素の描画バッファサイズは、実際のテレビ画像のディスプレイ部分のサイズを調べ、それに合わせた値を設定 (365x200) しています。
...
スタイルシートでは、position プロパティの指定により、img 要素と canvas 要素の位置をうまく合わせて表示するように調整します。
