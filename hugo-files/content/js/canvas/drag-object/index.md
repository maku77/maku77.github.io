---
title: "JavaScriptメモ: HTML5 Canvas 内のマウスドラッグで、描画オブジェクト全体を移動させる"
url: "p/3df8z6p/"
date: "2015-04-09"
tags: ["javascript"]
aliases: [/js/canvas/drag-object.html]
---
...
さらに、CanvasDragger によって canvas 内でのマウスドラッグを検出し、すべての Sprite を移動させて再描画しています。
