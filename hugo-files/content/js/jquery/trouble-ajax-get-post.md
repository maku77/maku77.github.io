---
title: "JavaScriptメモ: jQuery の ajax/get/post メソッドが動作しない"
url: "p/7r2q66y/"
date: "2013-10-29"
tags: ["javascript"]
aliases: [/js/jquery/trouble-ajax-get-post.html]
---
...
click イベントのデフォルト動作と重なってしまうケース
----

ボタンの click イベントをトリガーにして Ajax 通信を発生させる場合、デフォルトの click イベント処理と重複してうまく動かないことがあります。
