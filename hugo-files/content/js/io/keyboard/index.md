---
title: "JavaScriptメモ: キーボードからの入力を取得する"
url: "p/byc3c82/"
date: "2015-03-31"
tags: ["javascript"]
aliases: [/js/io/keyboard.html]
---
...
{{< file src="keyboard-demo.html" caption="デモページを開く (keyboard-demo.html)" >}}

下記は、キーボードから a b c とタイプしたときの出力です。
`keydown` と `keyup` の 2 つのイベントを捕捉しているため、キー入力ごとに 2 度情報が表示されます。
...
<div class="note">
似たようなプロパティとして、<code>charCode</code> や、<code>keyCode</code>、<code>which</code> プロパティがありますが、これらは既に deprecated（非推奨）プロパティとなっているため、使用してはいけません。
</div>
...
{{< file src="keyboard-demo2.html" caption="デモページを開く (keyboard-demo2.html)" >}}
