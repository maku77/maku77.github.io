...
const d = new Date(2018, 0, 31, 19, 30, 55);  // 2018年1月31日19時30分55秒
{{< /code >}}
...
const d = new Date(Date.UTC(2018, 0, 31));  // 2018年1月31日
{{< /code >}}
...
const d2 = new Date('1995-12-17T03:24:00Z');
{{< /code >}}
...
```javascript
const d = new Date();
const timestamp = d.getTime();  //=> 1522828862750
```
...
```js
const timestamp1 = Date.now();  // 現在時刻
const timestamp2 = Date.UTC(2018, 0, 31, 19, 30, 55);  // UTC で 2018年1月31日19時30分55秒
const timestamp3 = Date.parse('04 Dec 1995 00:12:00 GMT');  // 非推奨
```
