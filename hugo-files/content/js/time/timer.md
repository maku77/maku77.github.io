---
title: "JavaScriptメモ: タイマーで任意の関数を呼び出す (setTimeout, setInterval)"
url: "p/3gcvmoi/"
date: "2012-12-08"
tags: ["javascript"]
aliases: [/js/time/timer.html]
---
...
繰り返しのタイマー
----
1 回だけでなく、繰り返し関数を呼び出したい場合は `window.setTimeout()` の代わりに `window.setInterval()` を使用します。
